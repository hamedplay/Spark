...
export interface SecuritySettings {
  ...
  session_heartbeat_interval_seconds: number;
  lock_threshold: number;
  lock_duration_minutes: number;
  progressive_lock_enabled: boolean;
  progressive_lock_schedule: string[];
  recovery_enabled: boolean;
  unified_recovery_enabled: boolean;
  recovery_otp_ttl_seconds: number;
  recovery_max_attempts: number;
  recovery_reset_token_ttl_seconds: number;
