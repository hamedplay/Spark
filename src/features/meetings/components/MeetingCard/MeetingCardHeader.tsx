      ...
      <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
        ...
        {meeting.status === 'open' && (
          <div className="flex max-w-full flex-wrap items-center justify-end gap-1.5">
            ...
            <button onClick={onSendToTelegram} disabled={loading || meeting.status_type !== 'requested'} className={`${iconButtonClass} border-amber-100 bg-amber-50 text-amber-600 hover:bg-amber-100 dark:border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-300`} title="ارسال به مدیر" aria-label="ارسال به مدیر">
