    ...
    <div className="space-y-4" dir="rtl">
      ...
      {data && (
        <div className="space-y-4">
          ...
          <Section title="یکپارچگی هویت" ok={data.identity_integrity?.ok ?? false}>
            <StatusRow label="auth_without_profile" ok={data.identity_integrity?.auth_users_without_profile === 0} detail={String(data.identity_integrity?.auth_users_without_profile ?? 0)} />
            <StatusRow label="profile_without_auth" ok={data.identity_integrity?.profiles_without_auth_user === 0} detail={String(data.identity_integrity?.profiles_without_auth_user ?? 0)} />
            <StatusRow label="lifecycle_mismatch" ok={data.identity_integrity?.lifecycle_status_mismatches === 0} detail={String(data.identity_integrity?.lifecycle_status_mismatches ?? 0)} />
            <StatusRow label="phone_mismatch" ok={data.identity_integrity?.phone_identity_mismatches === 0} detail={String(data.identity_integrity?.phone_identity_mismatches ?? 0)} />
          </Section>
