...
const TABLES: TableConfig[] = [
  ...
  { key: 'meeting_inbox',                 label: 'صندوق جلسات',                    icon: Calendar,      color: 'text-teal-300',   description: 'صندوق ورودی جلسات کاربران' },
  { key: 'shared_meetings',               label: 'جلسات اشتراکی',                  icon: Calendar,      color: 'text-teal-200',   description: 'جلسات به اشتراک گذاشته‌شده' },
  { key: 'actions',                       label: 'اقدامات جلسه',                   icon: ClipboardList,  color: 'text-green-400',  description: 'اقدامات تعریف‌شده برای جلسات' },
  { key: 'tasks',                         label: 'وظایف',                          icon: ClipboardList,  color: 'text-green-500',  description: 'اقدامات و وظایف' },
  { key: 'task_workflow_steps',           label: 'مراحل گردش کار',                 icon: ClipboardList,  color: 'text-green-300',  description: 'مراحل گردش کار وظایف' },
  ...
  { key: 'chat_group_members',            label: 'اعضای گروه چت',                  icon: MessageSquare,  color: 'text-rose-300',   description: 'اعضای گروه‌های چت' },
  { key: 'chat_messages',                 label: 'پیام‌های چت',                    icon: MessageSquare,  color: 'text-rose-500',   description: 'پیام‌های داخلی سازمان' },
  { key: 'chat_message_stars',            label: 'ستاره‌دارهای چت',                icon: MessageSquare,  color: 'text-rose-600',   description: 'پیام‌های ستاره‌دار در چت' },
  { key: 'chat_message_reactions',        label: 'واکنش‌های چت',                   icon: MessageSquare,  color: 'text-rose-700',   description: 'واکنش‌های ایموجی در چت' },
  { key: 'chat_reminders',               label: 'یادآورهای چت',                   icon: MessageSquare,  color: 'text-rose-200',   description: 'یادآورهای پیام‌های چت' },
  ...
  { key: 'channel_group_tasks',          label: 'وظایف گروهی کانال',              icon: ClipboardList,  color: 'text-violet-600', description: 'وظایف گروهی در کانال‌ها' },
  { key: 'channel_group_task_assignments', label: 'انتساب وظایف کانال',           icon: ClipboardList,  color: 'text-violet-400', description: 'انتساب وظایف گروهی کانال‌ها' },
  { key: 'channel_group_task_activities',  label: 'فعالیت‌های وظایف کانال',       icon: ClipboardList,  color: 'text-violet-300', description: 'فعالیت‌های وظایف گروهی کانال‌ها' },
  { key: 'channel_message_stars',         label: 'ستاره‌دارهای کانال',            icon: MessageSquare,  color: 'text-indigo-700', description: 'پیام‌های ستاره‌دار در کانال‌ها' },
  { key: 'channel_message_reactions',     label: 'واکنش‌های کانال',               icon: MessageSquare,  color: 'text-indigo-800', description: 'واکنش‌های ایموجی در کانال‌ها' },
  { key: 'channel_message_private_pins',  label: 'پین‌های خصوصی کانال',          icon: MessageSquare,  color: 'text-indigo-200', description: 'پین‌های خصوصی پیام‌های کانال‌ها' },
  { key: 'channel_notification_rules',    label: 'قوانین اعلان کانال',            icon: FileText,       color: 'text-blue-300',   description: 'قوانین اعلان‌های کانال‌ها' },
  { key: 'channel_sms_rules',             label: 'قوانین پیامک کانال',            icon: FileText,       color: 'text-green-300',  description: 'قوانین ارسال پیامک کانال‌ها' },
  // ── Calendar ────────────────────────────────────────────────────────────────
  ...
  { key: 'calendar_subscriptions',        label: 'اشتراک تقویم‌ها',               icon: Calendar,       color: 'text-cyan-200',   description: 'اشتراک‌های تقویم کاربران' },
  // ── Notifications ───────────────────────────────────────────────────────────
  ...
  { key: 'notification_group_rules',      label: 'قوانین اعلان گروه‌ها',         icon: FileText,       color: 'text-blue-300',   description: 'قوانین اعلان برای گروه‌ها' },
  // ── User & Groups ───────────────────────────────────────────────────────────
  { key: 'user_preferences',             label: 'تنظیمات کاربران',                icon: Shield,         color: 'text-sky-500',    description: 'تنظیمات و ترجیحات کاربران' },
  { key: 'user_bale_mapping',            label: 'نگاشت بله کاربران',              icon: Shield,         color: 'text-sky-300',    description: 'ارتباط کاربران با پیام‌رسان بله' },
  { key: 'user_access_relations',        label: 'روابط دسترسی کاربران',           icon: Shield,         color: 'text-sky-400',    description: 'سطح دسترسی بین کاربران' },
  ...
  // ── Org Structure ───────────────────────────────────────────────────────────
  { key: 'org_organizations',            label: 'سازمان‌ها',                       icon: Table2,         color: 'text-cyan-900',   description: 'اطلاعات سازمان' },
  ...
  { key: 'org_position_permissions',     label: 'دسترسی‌های سمت‌ها',             icon: Table2,         color: 'text-cyan-500',   description: 'دسترسی‌های هر سمت سازمانی' },
  { key: 'org_level_definitions',        label: 'تعاریف سطوح سازمانی',            icon: Table2,         color: 'text-cyan-400',   description: 'تعریف سطوح ساختار سازمانی' },
  { key: 'org_level_permissions',        label: 'دسترسی‌های سطح سازمانی',         icon: Table2,         color: 'text-cyan-300',   description: 'دسترسی‌های هر سطح سازمانی' },
  // ── Config & Logs ───────────────────────────────────────────────────────────
  ...
  { key: 'spark_ai_settings',            label: 'تنظیمات هوش مصنوعی',            icon: Database,       color: 'text-purple-400', description: 'پیکربندی مدل هوش مصنوعی اسپارک' },
  { key: 'spark_field_keywords',         label: 'کلمات کلیدی اسپارک',            icon: Database,       color: 'text-purple-300', description: 'کلمات کلیدی فیلدهای اسپارک' },
  { key: 'spark_memory',                 label: 'حافظه اسپارک',                   icon: Database,       color: 'text-purple-200', description: 'حافظه شخصی اسپارک هر کاربر' },
  ...
  { key: 'sms_group_rules',              label: 'قوانین پیامک گروه‌ها',           icon: FileText,       color: 'text-green-400',  description: 'قوانین ارسال پیامک برای گروه‌ها' },
  { key: 'hr_sso_config',                label: 'پیکربندی HR/SSO',                icon: Database,       color: 'text-blue-500',   description: 'تنظیمات ورود یکپارچه و سیستم HR' },
  { key: 'rahyab_settings',              label: 'تنظیمات رهیاب',                  icon: Database,       color: 'text-green-700',  description: 'پیکربندی ارسال SMS رهیاب' },
