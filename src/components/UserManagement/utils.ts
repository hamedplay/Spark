...
import { Pencil, KeyRound, UserX, UserCheck, ShieldCheck, Phone, Link2, Activity, History, MapPin } from 'lucide-react';
...
export const inp = 'w-full pr-10 pl-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition text-sm';
