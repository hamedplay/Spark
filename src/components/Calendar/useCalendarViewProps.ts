...
export interface CalendarViewPropsInput {
  ...
  setSelectedJy: React.Dispatch<React.SetStateAction<number>>;
  setSelectedJm: React.Dispatch<React.SetStateAction<number>>;
  setSelectedJd: React.Dispatch<React.SetStateAction<number>>;
  allDayDragging: boolean;
  allDayDragStart: { jy: number; jm: number; jd: number } | null;
  allDayDragEnd: { jy: number; jm: number; jd: number } | null;
  setAllDayDragStart: React.Dispatch<React.SetStateAction<{ jy: number; jm: number; jd: number } | null>>;
  setAllDayDragEnd: React.Dispatch<React.SetStateAction<{ jy: number; jm: number; jd: number } | null>>;
  setAllDayDragging: React.Dispatch<React.SetStateAction<boolean>>;
