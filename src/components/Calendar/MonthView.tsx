...
export function MonthView(p: CalendarViewProps) {
  const { mainMonthDays, currentJy, currentJm, isToday, isSelected,
    getOccasionsForDay, getMeetings, getMeetingColor, toFarsiTime,
    setSelectedJy, setSelectedJm, setSelectedJd, setMonthDayPopup, onCreateMeetingForDay } = p;
