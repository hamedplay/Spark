...
export function AttachmentManager({ minuteId, canManage }: AttachmentManagerProps) {
      ...
      <div className="flex items-center justify-between">
        ...
        {canManage && (
          <button
            ...
            disabled={uploading}
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white transition-colors disabled:opacity-50"
          >
