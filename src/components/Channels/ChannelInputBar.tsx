...
const MESSAGE_TYPES: { key: ChannelMessageType; label: string; icon: React.ElementType; color: string; desc: string }[] = [
  { key: 'normal', label: 'پیام عادی', icon: MessageCircle, color: 'text-gray-500', desc: '' },
  { key: 'important', label: 'پیام مهم', icon: AlertCircle, color: 'text-amber-500', desc: 'اعلان روی صفحه' },
  { key: 'urgent', label: 'پیام اورژانسی', icon: AlertTriangle, color: 'text-red-500', desc: 'زنگ اعلان پخش می‌شود' },
  { key: 'confidential', label: 'پیام محرمانه', icon: Lock, color: 'text-gray-600', desc: 'تا کلیک مخاطب مخفی' },
];
