...
import { SmsMfaChallengeGate } from '../features/auth/components/SmsMfaChallengeGate';
...
const REASON_MESSAGES: Record<string, { title: string; description: string }> = {
  ...
  MFA_REQUIRED: { title: 'تأیید پیامکی', description: 'برای دسترسی کامل، کد پیامکی را وارد کنید.' },
  ACCOUNT_REJECTED: {
...
export function RestrictedAccessPage({ reasonCode, nextStep, onRefresh, onSignOut }: RestrictedAccessPageProps) {
  ...
  if (nextStep === 'verify_custom_mfa') {
    return <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900" dir="rtl"><SmsMfaChallengeGate onCompleted={onRefresh} onSignOut={handleSignOut} /></div>;
  }
