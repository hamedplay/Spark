...
function TaskCard({
  ...
  handleUpdateTask, finalAllUsers, userSelectorGroups, users, onOpenDetails, onEditTask,
}: TaskCardProps) {
        ...
        <>
          <div className="flex items-start justify-between gap-2 mb-3">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              {canEdit && (
                <button
                  onClick={() => onEditTask ? onEditTask(task) : (() => { setEditingTaskId(task.id); setEditingTask(task); setEditDueDate(null); setEditAssigneeId(task.current_assignee_id || ''); })()}
