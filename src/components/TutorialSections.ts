...
import { LayoutDashboard, Calendar, SquareCheck as CheckSquare, StickyNote, Phone, ChartBar as FileBarChart2, MessageCircle, Video, CircleUser as UserCircle, Hash, Bot, ChevronRight, ChevronLeft, Share2, Archive, Send, UserPlus, CalendarPlus, CreditCard as Edit2, Trash2, Paperclip, Smile, Mic, Image as ImageIcon, Star, Bell, BellOff, Tag, Clock, Users, Lock, Settings, Plus, RefreshCw, Download, Upload, ExternalLink, Eye, CircleCheck as CheckCircle2, Circle as XCircle, CircleAlert as AlertCircle, ListFilter as Filter, SlidersHorizontal, LogOut, Sun, Moon, Volume2, VolumeX, PhoneCall, Zap, Brain, Sparkles, Layers, Globe, Building2, ChartPie as PieChart, TrendingUp, Table, CalendarDays, Hop as Home, List, Forward, Reply, Pin, Activity, Newspaper, Palette, LayoutGrid, User, MonitorPlay, ArrowRightLeft, FileText, Printer, BellRing, SquarePen, CircleDot, CheckCheck, Hourglass, ListTodo, Repeat, CalendarClock, CalendarX, CalendarCheck, CalendarRange, Pencil, Search, ChevronLeft as AlignLeft, Bookmark, StickyNote as NoteIcon, FolderOpen, ImagePlus, File as FileAudio, AlarmClock, Eye as EyeIcon } from 'lucide-react';
