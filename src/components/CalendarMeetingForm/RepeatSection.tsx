...
export function RepeatSection(props: {
  ...
  setRepeatEnabled: (fn: (v: boolean) => boolean) => void;
  ...
  setEndDatePickerJy: (fn: (v: number) => number) => void;
  endDatePickerJm: number;
  setEndDatePickerJm: (fn: (v: number) => number) => void;
  scheduleDate: { jy: number; jm: number; jd: number } | null;
}) {
  const {
    repeatEnabled, setRepeatEnabled, repeatType, setRepeatType, repeatInterval, setRepeatInterval,
    repeatEndDate, setRepeatEndDate, repeatWeekday, setRepeatWeekday,
    repeatMonthlyMode, setRepeatMonthlyMode, repeatMonthlyNth, setRepeatMonthlyNth,
    repeatMonthlyNthWeekday, setRepeatMonthlyNthWeekday,
    showEndDatePicker, setShowEndDatePicker, endDatePickerJy, setEndDatePickerJy,
    endDatePickerJm, setEndDatePickerJm, scheduleDate,
  } = props;
