...
export function ExternalParticipantsSection(props: {
  ...
  setShowExternalDropdown: React.Dispatch<React.SetStateAction<boolean>>;
  ...
  const {
    externalSearchRef,
    selectedExternal, setSelectedExternal,
    externalSearch, setExternalSearch,
    showExternalDropdown, setShowExternalDropdown,
    filteredExternal,
