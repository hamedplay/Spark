...
export function CalendarSelectorSection(props: {
  calendars: CalendarEntry[];
  selectedCalendarId: string;
  setSelectedCalendarId: React.Dispatch<React.SetStateAction<string>>;
  selectedCalendar: CalendarEntry | undefined;
  membersOnly: boolean;
  setMembersOnly: React.Dispatch<React.SetStateAction<boolean>>;
}) {
  const { calendars, selectedCalendarId, setSelectedCalendarId, selectedCalendar, membersOnly, setMembersOnly } = props;
  return (
