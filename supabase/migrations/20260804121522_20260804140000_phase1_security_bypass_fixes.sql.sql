...
- All SELECT INTO no-rows cases handled with COALESCE guard
...
- REVOKE EXECUTE on all internal functions from PUBLIC, anon, authenticated
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 6. Phone login readiness fix (with COALESCE guards for no-rows SELECT)
-- ═══════════════════════════════════════════════════════════════════════════
