...
# 1. Remove decision_assigned producer from draft (moved to publish)
# 2. Fix name fallback to scalar subquery pattern
*/
...
BEGIN
  ...
  FOR i IN 0..jsonb_array_length(v_arr) - 1 LOOP
    ...
    -- decision_assigned is NOT emitted here during draft.
    -- It is emitted during publish in confirm_and_publish_minutes_by_chair.
  END LOOP;
