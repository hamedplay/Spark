/*
# Fix audience in manage_minutes_decision notification section

Replace the notification section (lines 246-303) to include correct audience per recipient.

Mapping:
- status_change/followup/reopened → owner gets audience=decision_owner
- obstacle/obstacle_resolved/completion → each recipient gets their role as audience
  - primary_owner_user_id → decision_owner
