...
REVOKE ALL ON FUNCTION private.list_malformed_phone_records() FROM anon;
GRANT EXECUTE ON FUNCTION private.list_malformed_phone_records() TO authenticated;
...
REVOKE ALL ON FUNCTION private.clear_malformed_phone_record(uuid) FROM anon;
GRANT EXECUTE ON FUNCTION private.clear_malformed_phone_record(uuid) TO authenticated;
